...
# This debugging block was not added by default
# it was included here, as version upgrades from 1.38 to 1.39 prooved 
# to be very hard without error_reporting as the top line
if (loadenv('APP_DEBUG', false) === "true") {
  $hostName = gethostname();
  error_reporting( -1 );
  ini_set( 'display_errors', 1 );
  // hostname will allow to create separate log file for each instance
  $wgDebugLogFile = "/var/www/html/mediawiki-debug-$hostName.log";
