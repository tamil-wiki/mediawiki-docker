...
class SearchMySQL extends SearchDatabase {
	...
	public function normalizeText( $string ) {
		//Patch by Madhusudhanan Sampath 25-Mar-25
		// Skip munging for Tamil (U+0B80–U+0BFF)
		//so that Tamil words are carried as-is into
		//Searchindex table si_title column
		//Otherwise, this was getting populated with
		//Ascii-safe Hex garbage
		if ( preg_match('/[அ-௸]/u', $string) ) {
			return $string;
		}
	
		// Default munging for other scripts
