...
ARG MEDIAWIKI_EXTENSIONS=${MEDIAWIKI_EXTENSIONS:-'MobileFrontend TemplateStyles BlueSpiceDashboards AccessControl Cargo WikiSEO Description2 MetaMaster ContactPage UserMerge TabberNeue Popups RevisionSlider RottenLinks BlueSpiceSaferEdit StandardDialogs Moderation LastUserLogin ExternalLinkConfirm intersection BlueSpiceCategoryManager ContributionScores CreatePageUw'}
